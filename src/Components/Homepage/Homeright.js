  ...
  return (
    <div className="w-1/4 flex ss:hidden xs:hidden sm:block md:block lg:block xl:block  flex-col" style={{ placeItems: "center" }}>
      <div className="mt-7 flex w-full flex-row">
        <textarea
          className="text-black ss:w-auto xs:w-auto sm:ml-auto md:mr-5 lg:mr-5 xl:mr-5 rounded-[30px] border-2 pl-5 pt-3"
        ...
        />
        <SearchIcon className=" md:mr-5 lg:mr-5 xl:mr-5 mt-2"
      ...
      <div className="flex w-full ml-2 mr-2 flex-col">
        <div className="mt-5 rounded-[20px]  ">
          ...
          <div className="mt-2 mx-5 ss:mx-auto xs: mx-auto sm:mx-auto flex flex-col">
        ...
        <div className="mt-5 w-auto rounded-[20px] bg-black">
          <span className="text-[25px] ml-10 text-white opacity-100">
            Live Contests
          </span>
